...
#Sequence builder
#**************************************************************
process.stdPhotonJetSeq = cms.Sequence()

process.load("MyFlashggPlugins.DiphotonVertex.flashggPhotonJetValidationSequence_cff")
if options.isData:
    process.flashggPhotonJetValidationSequence.remove(process.flashggMicroAODGenSequence)
process.stdPhotonJetSeq *= process.flashggPhotonJetValidationSequence

#process.flashggPhotonJet.vertexIdMVAweightfile = cms.FileInPath("MyFlashggPlugins/DiphotonVertex/data/TMVAClassification_BDTVtxId_SL_2017.xml")
#process.flashggPhotonJet.vertexProbMVAweightfile = cms.FileInPath("MyFlashggPlugins/DiphotonVertex/data/TMVAClassification_BDTVtxProb_SL_2017.xml")
...
process.stdPhotonJetSeq *= process.commissioning

process.p = cms.Path( process.stdPhotonJetSeq )
